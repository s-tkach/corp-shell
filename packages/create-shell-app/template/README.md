...
2. Fill in:
   - **Name**: `{{APP_NAME}}`
   - **Remote URL**: the base URL where `remoteEntry.js` is served (e.g. `https://cdn.example.com/{{APP_NAME}}`)
   - **Route Prefix**: the path the shell mounts this app at (e.g. `/{{APP_NAME}}`)
